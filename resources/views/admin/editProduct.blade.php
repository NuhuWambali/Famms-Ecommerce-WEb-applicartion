          ...
          <div class="content-wrapper">
             ...
             @endif
               <div class="addproductdiv">
                    <h2 class="headProductCss">Edit Product</h2>
               </div>
               <form action="{{url('update_product_edit',$data->id)}}" method="post" enctype="multipart/form-data">
                @csrf
               <div class="formCss">
                        <div class="mb-3">
                            <label for="exampleInputProductTitle" class="form-label">Product Title</label>
                            <input type="text" class="form-control" id="productFormColor" placeholder="Enter a title" name="title" required="" value="{{$data->title}}">
                        </div>
                        <div class="mb-3">
                            <label for="exampleInputProductDescription" class="form-label">Product Description</label>
                            <input type="text" class="form-control" id="productFormColor" placeholder="Enter a description" name="description" required="" value="{{$data->description}}">
                        </div>
                        <div class="mb-3">
                            <label for="exampleInputProductPrice" class="form-label">Product Price</label>
                            <input type="number" class="form-control" id="productFormColor" placeholder="Enter a price" name="price" required="" value="{{$data->price}}">
                        </div>
                        <div class="mb-3">
                            <label for="exampleInputProductDiscount" class="form-label">Product Discount</label>
                            <input type="number" class="form-control"  id="productFormColor" placeholder="Enter a discount" name="discount_price" value="{{$data->discount_price}}">
                        </div>
                        <div class="mb-3">
                            <label for="exampleInputProductDiscount" class="form-label">Product Quantity</label>
                            <input type="number" class="form-control"  min="1" id="productFormColor" placeholder="Enter a quantity" name="quantity" required="" value="{{$data->quantity}}">
                        </div>
                        <div class="mb-3">
                       ...
                       <div class="mb-3">
                            ...
                            <img style="margin-bottom:13px;" width="200px" height="200px" src="/products/{{$data->image}}">
